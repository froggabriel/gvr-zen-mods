...
|-----|---------|---------|-------------|
| [pin-align](pin-align/) | ![pin-align](pin-align/screenshot.png?v=1) | 1.0.4 | Fixes pinned folder-tab icon alignment in the collapsed rail |
| [active-first](active-first/) | ![active-first](active-first/screenshot.png?v=1) | 1.0.1 | Sorts inactive tabs to the bottom when expanded; hides them in the collapsed rail |
...
| [pinned-in-rail](pinned-in-rail/) | ![pinned-in-rail](pinned-in-rail/screenshot.png?v=1) | 1.0.1 | Keeps loaded pinned tabs visible in the rail when the workspace section is collapsed |
