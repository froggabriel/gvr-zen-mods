...
| [clean-sidebar-header](clean-sidebar-header/) | ![clean-sidebar-header](clean-sidebar-header/screenshot.png) | 1.0.0 | Hides the title bar in extension sidebars — **no eoh or rail dependencies** |
